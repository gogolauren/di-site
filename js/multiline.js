...
//Draw tooltips
    ...
    // images of dogs
    focus.append("svg:image").attr("xlink:href", "img/dogs/labrador.png").attr("x", x+10).attr("y", y+6).attr("width", "20").attr("height", "20");
    focus.append("svg:image").attr("xlink:href", "img/dogs/labrador-mix.png").attr("x", x+10).attr("y", y+26).attr("width", "20").attr("height", "20");
    focus.append("svg:image").attr("xlink:href", "img/dogs/golden-retriever.png").attr("x", x+10).attr("y", y+46).attr("width", "20").attr("height", "20");
    focus.append("svg:image").attr("xlink:href", "img/dogs/beagle.png").attr("x", x+10).attr("y", y+66).attr("width", "20").attr("height", "20");
    focus.append("svg:image").attr("xlink:href", "img/dogs/AM.png").attr("x", x+8).attr("y", y+86).attr("width", "25").attr("height", "25");
    focus.append("svg:image").attr("xlink:href", "img/dogs/german-shepherd.png").attr("x", x+8).attr("y", y+106).attr("width", "21").attr("height", "21");
    focus.append("svg:image").attr("xlink:href", "img/dogs/shihTzu.png").attr("x", x+9).attr("y", y+126).attr("width", "22").attr("height", "22");
    focus.append("svg:image").attr("xlink:href", "img/dogs/chihuahua.png").attr("x", x+10).attr("y", y+148).attr("width", "20").attr("height", "20");
